...
def resolve_agent_model_version(requested_model: str, runtime_config: PlatformRuntimeConfig) -> str:
    model = requested_model.strip()
    return runtime_config.default_agent_model if model.lower() in PLACEHOLDER_MODEL_VERSIONS else model
